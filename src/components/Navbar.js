...
const Navbar = () => {
	...
	useEffect(() => {
		if (
			window.location.href == 'https://wavy-cd33d.web.app/admin' ||
			window.location.href == 'https://wavy-cd33d.web.app/admin/dashboard' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/posts' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/posts/remove' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/posts/waiting' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/tour_guides/requests' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/tour_guides/remove' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/recommendations' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/tour_guides' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/reports' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/posts/trash' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/tour_guides/trash' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/reports/show_reports' ||
			window.location.href ==
				'https://wavy-cd33d.web.app/admin/dashboard/reports/trash'
		) {
	...
	const exitMenu = () => {
		document.getElementById('mobileNav').style.top = '-200%';
	};
	...
	return (
		<nav className='fixed right-0 left-0 top-0 z-30'>
			...
			<div
				id='mobileNav'
				className='h-screen bg-green-400 fixed -top-full left-0 right-0 transition-all duration-300 ease-in-out'>
